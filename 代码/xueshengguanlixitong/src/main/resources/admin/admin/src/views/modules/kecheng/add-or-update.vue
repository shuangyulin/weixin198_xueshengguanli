        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="课程图片" prop="kechengPhoto">
                        <file-upload
                            tip="点击上传课程图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengPhoto" label="课程图片" prop="kechengPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="结束时间" prop="xiakeTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xiakeTime"
                                type="datetime"
                                placeholder="结束时间"
                                :disabled="ro.xiakeTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiakeTime" label="结束时间" prop="xiakeTime">
                            <span v-html="ruleForm.xiakeTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
