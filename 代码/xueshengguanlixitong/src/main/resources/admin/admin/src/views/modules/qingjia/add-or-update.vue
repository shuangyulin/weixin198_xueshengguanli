    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="请假时间" prop="qingjiaTime">
                        <el-date-picker
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假时间(天)" prop="qingjiaNumber">
                       <el-input v-model="ruleForm.qingjiaNumber"
                                 placeholder="请假时间(天)" clearable  :readonly="ro.qingjiaNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="请假时间(天)" prop="qingjiaNumber">
                           <el-input v-model="ruleForm.qingjiaNumber"
                                     placeholder="请假时间(天)" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="请假原因" prop="qingjiaText">
                        <el-input type="textarea"  :readonly="ro.qingjiaText" v-model="ruleForm.qingjiaText" placeholder="请假原因"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qingjiaText" label="请假原因" prop="qingjiaText">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   qingjiaNumber: [
                              { required: true, message: '请假时间(天)不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   qingjiaYesnoText: [
                              { required: true, message: '审核原由不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
