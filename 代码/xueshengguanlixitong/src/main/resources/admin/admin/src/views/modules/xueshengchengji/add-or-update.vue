    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="科目" prop="xueshengchengjiName">
                       <el-input v-model="ruleForm.xueshengchengjiName"
                                 placeholder="科目" clearable  :readonly="ro.xueshengchengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="科目" prop="xueshengchengjiName">
                           <el-input v-model="ruleForm.xueshengchengjiName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生成绩" prop="xueshengchengji">
                       <el-input v-model="ruleForm.xueshengchengji"
                                 placeholder="学生成绩" clearable  :readonly="ro.xueshengchengji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="学生成绩" prop="xueshengchengji">
                           <el-input v-model="ruleForm.xueshengchengji"
                                     placeholder="学生成绩" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="成绩详情" prop="xueshengchengjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xueshengchengjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengchengjiContent" label="成绩详情" prop="xueshengchengjiContent">
                            <span v-html="ruleForm.xueshengchengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xueshengchengjiContent: [
                              { required: true, message: '成绩详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
