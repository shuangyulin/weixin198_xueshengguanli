    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {},
                user: {},
                heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"20px","headUserInfoFontColor":"rgba(84, 88, 179, 1)","headBoxShadow":"0 2px 17px 2px rgb(180 184 255)","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(86, 88, 182, 1)","headFontColor":"rgba(47, 50, 72, 1)","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20210223/c1223b6716cc43669b76cbffddc9c171.png","headBgColor":"#fff","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(84, 88, 179, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
            };
        },
        created() {
            this.setHeaderStyle()
