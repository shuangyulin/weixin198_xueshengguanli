    		...
    		<view class="container">
                <view class="detail-content">
                    <view class="detail-list-item"
                          :style='{"boxShadow":"0 0 10rpx rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"#A27DE3","backgroundColor":"#fff","borderRadius":"10rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
                        <view class="lable"
                ...
                <view class="time-content"
                      :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"#A27DE3","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"100%"}'
                      style="height:auto !important;">
                    <view class="header" :style='{"color":"#A27DE3","fontSize":"28rpx"}'>
                        内容
                    </view>
