...
<view class="uni-product-list" :style='{"borderRadius":0,"backgroundColor":"rgba(224, 224, 224, 1)"}'>
    <view
                ...
                class="uni-product"
                :style='{"borderRadius":"50rpx","backgroundColor":"#A27DE3"}' v-for="(product,index) in list" :key="index">
	...
	export default {
		...
		methods: {
			...
			async upCallback(mescroll) {
                ...
                let res = await this.$api.page(`kecheng`, params);
			...
			async search() {
                ...
                let res = await this.$api.page(`kecheng`, searchForm);
				// 如果是第一页数据置空
