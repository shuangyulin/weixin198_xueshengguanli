    ...
    */
    ...
    public R save(@RequestBody XueshengchengjiEntity xueshengchengji, HttpServletRequest request){
        ...
        Wrapper<XueshengchengjiEntity> queryWrapper = new EntityWrapper<XueshengchengjiEntity>()
            ...
            .eq("xueshengchengji", xueshengchengji.getXueshengchengji())
            ;
...
//                            xueshengchengjiEntity.setXueshengchengjiName(data.get(0));                    //科目 要改的
//                            xueshengchengjiEntity.setXueshengchengji(Integer.valueOf(data.get(0)));   //学生成绩 要改的
//                            xueshengchengjiEntity.setXueshengchengjiContent("");//照片
